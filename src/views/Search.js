            ...
            <div className="flex flex-col lg:flex-row">
                <div className="flex flex-col w-full">
                    <div className=" w-full">
                        ...
                        <p className="text-center">Хайх <span className="text-primary capitalize">{words}</span>  <span className={page === 1 ? "hidden " : ""}>Хуудас <span className="text-primary">{page}</span></span></p>
